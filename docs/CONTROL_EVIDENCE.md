...
| Reproducible schema | Alembic revisions 0001–0010, version check on API startup | empty upgrade/downgrade/upgrade and restricted-role tests | `public.alembic_version`; deployment job completion |
